		...
		*  rendering path as a fresh generation. */
		...
		function ImageGenPanel(props) {
			...
			*  history image route, then delegates to addToGallery). */
			...
			const promptLimit = promptCharLimit(modeModels.includes(model) ? model : modeModels[0] ?? "");
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
														...
														children: [
															...
															/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																...
																"data-over": promptOverLimit ? "" : void 0,
																title: promptOverLimit ? tt("prompt.overLimit", { limit: promptLimit ?? 0 }) : void 0,
																children: promptLimit === null ? tt("prompt.count", { count: prompt.length }) : tt("prompt.countLimit", {
																	count: prompt.length,
																	limit: promptLimit
																})
															})
